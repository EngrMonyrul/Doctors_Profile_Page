      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            experienceDetails('Medicine Award Winner', '1990'),
            const SizedBox(
              height: 10,
            ),
            experienceDetails('AMA Scientific Achievement Award', '2001'),
            const SizedBox(
              height: 10,
            ),
            experienceDetails('APUA Leadership Award', '2016'),
          ],
        ),
      ),
    ),
